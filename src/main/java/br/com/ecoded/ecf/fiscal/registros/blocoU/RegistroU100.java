package br.com.ecoded.ecf.fiscal.registros.blocoU;

public class RegistroU100 {

	private final String reg = "U100";
	...
	private String val_cta_ref_deb;
	private String val_cta_ref_cred;
	...
	public String getVal_cta_ref_deb() {
		return val_cta_ref_deb;
	}

	public void setVal_cta_ref_deb(String val_cta_ref_deb) {
		this.val_cta_ref_deb = val_cta_ref_deb;
	}

	public String getVal_cta_ref_cred() {
		return val_cta_ref_cred;
	}

	public void setVal_cta_ref_cred(String val_cta_ref_cred) {
		this.val_cta_ref_cred = val_cta_ref_cred;
	}
