...
public class RegistroK155 {

	private final String reg = "K155";
	...
	private List<RegistroK156> registroK156;
	...
	public List<RegistroK156> getRegistroK156() {
		if (registroK156 == null) {
			registroK156 = new ArrayList<RegistroK156>();
		}
		return this.registroK156;
	}
