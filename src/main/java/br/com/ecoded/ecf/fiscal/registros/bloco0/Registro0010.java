...
public class Registro0010 {
	...
	private String ind_rec_receita;
	...
	public String getInd_rec_receita() {
		return ind_rec_receita;
	}

	public void setInd_rec_receita(String ind_rec_receita) {
		this.ind_rec_receita = ind_rec_receita;
	}
